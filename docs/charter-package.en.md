...
**Part 2, Project Charter.** 2A Charter elements, all fourteen in the book's order, including the business case, the risk register R1 to R11, the milestone schedule, and the budget. 2B The PROJECT CHARTER form, filled in, four pages.
...
| D4 | Iteration 2 release, F06 to F12 | M4 |
...
| D11 | Mobile app published on Google Play and the App Store under the center's accounts, with store listings, release notes, signing keys, and the API documentation handed over | M6 |
...
D1 to D11 as listed in section 1.2: requirement specification, design baseline, two iteration releases, test documentation, migrated and reconciled data, production deployment with a tested restore, user and administrator documentation with trained staff, source code and technical documentation, the closeout report, and the mobile app published in both stores.
...
| R3 | Loss or absence of a developer, or of the part-time mobile developer | Pair on the scheduling and tuition modules; keep code and documentation in shared repositories; sponsor-approved replacement within 2 weeks |
...
| 6 | Contingency reserve | 28,000,000 | 4% | Inside the cost baseline; drawn by the project manager only against risks R1 to R11, through change control |
...
**Budget management and variance.** May commit and spend within the approved baseline, including <mark>single transactions up to 20,000,000 VND</mark> and use of the 28,000,000 VND contingency reserve against risks R1 to R11. Manages cumulative cost variance up to 5% of baseline. Escalates to the sponsor any forecast overrun beyond 5%, <mark>any reserve use beyond 20,000,000 VND</mark>, and any change in total funding.
