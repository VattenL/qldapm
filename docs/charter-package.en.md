...
| D10 | First warranty month completed, warranty for months 2 to 6 handed to the support desk, closeout report and lessons learned | M7 |
...
| R7 | Go-live slips and pushes the first warranty month into the Lunar New Year break | Baseline go-live at M6, a full month before the break; escalate to the sponsor immediately on a forecast slip past 15 January 2027, and re-plan the warranty rather than compress it silently |
